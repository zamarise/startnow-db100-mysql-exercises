...
SELECT staff.first_name AS first_name, staff.last_name AS last_name, address.address AS address, address.address2 AS address2, address.city_id AS city, address.district AS district, address.postal_code AS postal_code
FROM staff
LEFT JOIN address
ON staff.address_id = address.address_id
LEFT JOIN city
ON address.address_id = address.city_id;
